...
>>>>>>> 12a94a6af1f2eed0f83ef88e10cf7484ed4d4ae6:contact.html
            </nav>
          </div>
        </div>
      </div>
      <div class="container" style="margin-top: 110px; text-align: center">
        <h2 class="aboutUs-page-hero-text"><span>C</span><span>O</span><span>N</span><span>T</span><span>A</span><span>C</span><span>T</span></h2>
...
>>>>>>> 12a94a6af1f2eed0f83ef88e10cf7484ed4d4ae6:contact.html
            ...
            <div class="col-md-6 mt-5 mt-md-0">
              <form id="contact-form" class="contact-form" autocomplete="off" method="POST" action="contact.php">
                <div class="row">
